...
- **KHÔNG HARDCODE**: Tuyệt đối không viết cứng bất kỳ chuỗi text tiếng Việt hay tiếng Anh nào trong code UI. Tất cả các chuỗi hiển thị, nhãn, thông tin thông báo, thời gian (ví dụ: "vài phút trước", "ngày trước"), hay tiêu đề cột khi xuất file (Excel, PDF) đều bắt buộc phải được đưa vào file i18n duy nhất ([common.json](file:///d:/Coding/my-task-app/src/i18n/locales/vi/common.json)) và gọi thông qua hàm `t()`.
