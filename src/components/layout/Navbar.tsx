                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center justify-center">
                                    <Icon
                                        className={`w-5 h-5 transition-transform duration-300 ${active ? "scale-110 text-primary" : "text-default-400 group-hover:text-default-500"}`}
                                    />
                                    <span
                                        className={`text-xs mt-1 tracking-tight font-medium transition-colors duration-300 ${active ? "text-primary font-bold" : "text-default-400 group-hover:text-default-500"}`}
                                    >
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                key={item.path}
                                href={item.path}
                                className={`flex items-center gap-3.5 px-4 py-3 rounded-xl transition-all duration-200 text-left font-medium text-sm ${
                                    active
