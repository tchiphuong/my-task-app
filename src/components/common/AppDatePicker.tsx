...
interface AppDatePickerProps extends Omit<React.ComponentProps<typeof HeroDatePicker>, "children"> {
  label?: ReactNode;
}
  ...
  return (
    <HeroDatePicker {...props}>
      ...
      <HeroDatePicker.Popover>
        <Calendar aria-label={typeof label === "string" ? label : "Select date"}>
          <Calendar.Header>
